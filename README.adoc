...
CHICKEN 5:: Install the NixOS packages +chicken+,
  ...
  libraries.footnote:[Please remember that CHICKEN 5 is not an R⁷RS
  implementation. It does not, for instance, recognize the same syntax
  for escapes in strings. CHICKEN 6 will be an R⁷RS implementation,
  but does not work yet with Pipchix (as of 2025-11-26).]
