...
with neither R⁶RS nor R⁷RS, and perhaps never will be. But I support
it because it is ubiquitous since having been linked pointlessly to
GNU Make.footnote:[You can use a Scheme with the GNU Make
+$(shell ...)+ function, and the Scheme need not be Guile.]
